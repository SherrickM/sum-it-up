              ...
              <div className="video-info">
                <div className="video-info-text">
                  <form className="section-part left" onSubmit={onFormSubmit}>
                    <div
                      className="search-wrapper mt-3 file-name profile-input"
                      id="summary-input-area"
                    >
                      <textarea
                        rows="20"
                        cols="50"
                    ...
                    <div
                      class="search-wrapper mt-1 file-catagory"
                      id="summary-sentance-num"
                    >
                      <input
                        class="input"
                        type="number"
                        ...
                        placeholder="Number of sentences e.g. 3 or 5. Default is 1"
                        min="1"
                      />
                    </div>
                    ...
                    <button
                      ...
                      class="btn btn-secondary btn-main m-2 submit_for_summery"
                    >
                      Summarize!
                    </button>
                  </form>
        ...
        <div className="files-table w-50 ">
          <div className="files-table-header">
            <ol className="sum-results-output">
              <li className="files-table-row">
                {" "}
                {sumarizeMe ? (
                  <SummaryResults text={sumarizeMe} sentnum={sentenceNum} />
                ) : null}
              </li>
            </ol>
            <form>
              <div className="search-wrapper mt-3 file-name mb-5">
                <input
                  ...
                  placeholder="Name of Project e.g. Climate Change"
                />
              </div>

              <button
                onClick={onSaveSummaryClick}
                type="save"
                className="btn btn-secondary btn-main submit_for_summery"
              >
                Save summary!
              </button>
            </form>
